...
export default {
    ...
    init: function (element, options) {
        ...
        // toolbar
        const tool_bar = this._createToolBar(doc, options.buttonList, options.plugins, options.lang, options.editorType);
    ...
    _defaultButtons: function (lang) {
        return {
            ...
            underline: ['_se_command_underline', lang.toolbar.underline + ' (CTRL+U)', 'U', '',
     ...
     * @private
     */
    _createToolBar: function (doc, buttonList, _plugins, lang, type) {
        ...
        if (type !== undefined) {
             if (type === 'unitEdit') {
                tool_bar.style = 'position: sticky; top: -16px;'
            }
        }
